"""
Training script for XGBoost Survival model with Cox objective.

This script trains an XGBoost model with survival:cox objective and logs to Weights & Biases.

Usage:
    python train_xgb_cox.py --data data/processed --output models/xgb_cox_model.pkl
    python train_xgb_cox.py --data data/processed --output models/xgb_cox_model.pkl --eta 0.05 --max-depth 3
"""
...
def main():
    """Main XGBoost Cox training pipeline."""
    parser = argparse.ArgumentParser(description="Train XGBoost Survival model with Cox objective")
    parser.add_argument("--data", type=str, default="data/processed", 
                        help="Path to processed data directory")
    parser.add_argument("--output", type=str, default="models/xgb_cox_model.pkl", 
    ...
    parser.add_argument("--wandb-run", type=str, default="xgb-cox", 
                        help="Weights & Biases run name")
    args = parser.parse_args()
    
    setup_logging()
    
    print("Starting XGBoost Cox model training...")
    ...
    try:
        ...
        print("XGBoost Cox training complete!")
